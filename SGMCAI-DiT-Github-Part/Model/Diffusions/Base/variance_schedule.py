...
class VarianceSchedule(object):
    ...
    def __init__(self, schedule_name="linear_beta_schedule", beta_start=None, beta_end=None):
        ...
        # 定义函数字典
        beta_schedule_dict = {'linear_beta_schedule': self.linear_beta_schedule,
                              'cosine_beta_schedule': self.cosine_beta_schedule,
                              'quadratic_beta_schedule': self.quadratic_beta_schedule,
                              'sigmoid_beta_schedule': self.sigmoid_beta_schedule}
